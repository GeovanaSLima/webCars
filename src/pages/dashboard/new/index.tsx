  ...
  function handleDeleteImage(itemUid: string | null) {
    ...
    if (confirmed) {
      setImages((prevImages) =>
        prevImages.filter((image) => image.uid !== itemUid)
      );
    }
  }
    ...
    <Container>
      ...
      <div className="w-full bg-white p-7 rounded-lg flex flex-col items-center gap-2">
        <div className="w-full md:w-2/3 flex flex-col items-center">
          ...
          <div
            className={`w-full h-full grid gap-4 ${images.length === 0 ? "grid-cols-1" : "grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center"}`}
          >
            <label
              htmlFor="file-upload"
              className="w-full h-40 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 cursor-pointer"
            >
            ...
            {images.map((item) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => handleDeleteImage(item.uid)}
                >
      ...
      <div className="w-full bg-white p-7 rounded-lg flex flex-col items-center gap-2 mt-2">
        ...
        <form className="w-full md:w-2/3" onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-7">
            <p className="text-base/4 font-medium text-gray-900 mb-4">
              Nome do Carro
            </p>
            <Input
              type="text"
          ...
          <div className="mb-7">
            ...
            <textarea
              ...
              name="description"
              id="description"
              placeholder="Digite a descrição completa do caro..."
            />
            {errors.description && (
          ...
          <button
            type="submit"
            className="w-full md:w-1/3 h-10 rounded-md bg-zinc-900 text-white font-medium"
          >
            Cadastrar
          </button>
        </form>
